...
/// See also:
///
///  * [CustomScrollView], which integrates the [MySliverPersistentHeader] into its
///    scrolling.
...
class MySliverPersistentHeader extends StatefulWidget {
...
class _MySliverPersistentHeaderState extends State<MySliverPersistentHeader> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(MySliverPersistentHeader oldWidget) {
